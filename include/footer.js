document.write(`
      ...
      <div class="container-lg">
        <div class="main-footer">
          <div class="row gy-3 gy-md-4 gy-xl-0">
            ...
            <div class="nav-footer col-lg-3 col-md-4 order-md-3 order-lg-2">
            ...
            <div class="nav-footer col-xl-3 col-lg-3 col-md-4 order-md-5 order-lg-4">
              <div class="nav d-md-block content-box">
  ...
  <footer class="mobile-menu-footer d-sm-none dark-footer">
    <ul>
      <li>
  ...
  <div class="modal view-product fade dark-modal view-dark-product" id="viewModal" tabindex="-1"
    aria-labelledby="viewModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <span class="close-modal d-none d-md-block" data-bs-toggle="modal" data-bs-target="#viewModal"><i
              data-feather="x"></i></span>
          <div class="row gy-4 g-md-0">
            <div class="col-md-7">
              <div class="slider-box">
                <span class="close-modal d-md-none" data-bs-toggle="modal" data-bs-target="#viewModal"><i
                    data-feather="x"></i></span>
                <div class="row g-2">
                  <div class="col-2">
            ...
            <div class="col-md-5">
              <div class="product-detail-box">
                <div class="product-option">
                  <h4>Luxury silver and golden watch</h4>
                  <div class="option price">
                    <h5>Price</h5>
                    <span> Rs 200.00 </span> <del>Rs 300.00</del>
                  </div>
                  <div class="option">
                    <h5>Product Description</h5>
                    <p class="content-color">Gold plated luxury analog watch, it has 3 hands with roman number , it back
                      silver plated curved round. pull pin controller</p>
                  </div>
                  <div class="option">
                    <h5>Your Brand Color:</h5>
                    <span class="no-available"> No color available</span>
                  </div>
                  <div class="option">
                    <h5>Size:</h5>
                    <ul class="size-list size-watch">
                  ...
                  <div class="option">
                    <h5>Quantity:</h5>
                    <div class="plus-minus dark-plus-minus">
